...
/**
 * The conversational surface. The homepage is now the deep research console,
 * so chat lives here — `?chatId=` resumes a saved session and `?q=` prefills
 * the composer, exactly as they did on `/` before.
 */
function ChatContent() {
  ...
  useEffect(() => {
    setCurrentSessionId(searchParams.get('chatId') || undefined);
  }, [searchParams]);
