...
/**
 * First-land intro. A restrained line-art research campus on the app's own
 * background with the wordmark in the homepage title's typography, fading and
 * blending straight into the app. Shows once per browser (localStorage),
  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          {/* Full-bleed line-art campus (its warm-white field matches the app
