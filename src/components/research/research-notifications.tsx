...
import { seedSeenIfFirst, fireCompletionNotification } from "./report-notify";
  ...
  useEffect(() => {
    ...
    for (const r of reports) {
      ...
      const becameTerminal =
        before && !isTerminal(before) && isTerminal(r.status);
      ...
      <AnimatePresence>
        {toasts.map((t) => (
          <motion.div
            ...
            className="flex items-start gap-3 rounded-2xl border border-border bg-card p-3.5 shadow-lg"
          >
            <span
