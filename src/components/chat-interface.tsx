              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 px-2 sm:px-0">
                  {EXAMPLE_PROMPTS.map((example, i) => (
                    <motion.button
                      ...
                      className={
                        example.featured
                          ...
                          : "bg-gray-50 dark:bg-gray-800/50 p-2.5 sm:p-4 rounded-xl border border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800 text-left group"
                      }
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      <div
                        className={`mb-1.5 sm:mb-2 text-xs sm:text-sm font-medium ${
                          example.featured
