/**
 * Slim, client-facing shapes for Valyu workflow templates plus a normalizer
 * from the raw catalog object. Pure module (client + server safe).
 */
...
export function normalizeWorkflow(raw: any): WorkflowDTO {
  return {
    ...
    variables: Array.isArray(raw.variables)
      ? raw.variables.map(normalizeVariable)
      : [],
